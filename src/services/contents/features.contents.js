...
Short Description:`;
  ...
  for (let i = 0; i < numberOfSuggestions; i++) {
    ...
    productDescriptionSEOFriendlyList.push(choices[0].message.content.trim());
  }
...
Review:`;
  ...
  for (let i = 0; i < numberOfSuggestions; i++) {
    ...
    openAPIInformationsList.push({ id, object, created, model });
    productReviewList.push(choices[0].message.content.trim());
  }
...
Product names:`;
  ...
  for (let i = 0; i < numberOfSuggestions; i++) {
    ...
    openAPIInformationsList.push({ id, object, created, model });
    generateProductNameList.push(choices[0].message.content.trim());
  }
