 ...
 * This function checks the user's subscription status and free trial eligibility before generating content.
 *
 * @param {Object} req - The request object containing user information and task details.
...
const generate = catchAsync(async (req, res) => {
  ...
  // Check if the user is eligible to generate content based on their subscription and trial status
  if (words === 0 && !isAdmin) {
